...
Algorithmic trading bot for Interactive Brokers that predicts short-term price movements using Pearson correlations across the full S&P 500 universe (~500 tickers). Both direct and inverse correlations are used as predictors.

## Requirements

```bash
pip install ib_insync pandas numpy scikit-learn matplotlib nest_asyncio
```
